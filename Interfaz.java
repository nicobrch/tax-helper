...
public class Interfaz extends JFrame implements ActionListener {
    ...
    public void panelTabla() {
        ...
        botonEjecutar.addActionListener(e -> {
            ...
            Double[][] tablaRango = lector.getMatriz();
            lector.imprimirMatriz();
            ...
            // System.out.println( tab.ImpuestoGlobalComplementario(tab.rentaAnual(tab.totalSueldoImponible(matrix),tab.totalHonorarios(matrix),tab.gastosPresuntos(tab.totalHonorarios(matrix))), tablaRango) );
            // System.out.println( tab.PagoDevolucion(tab.totalImpuestos(),tab.ImpuestoGlobalComplementario(tab.rentaAnual(tab.totalSueldoImponible(matrix),tab.totalHonorarios(matrix),tab.gastosPresuntos(tab.totalHonorarios(matrix))),matrix)) );
            remove(panel2);
            panelFinal();
            revalidate();
